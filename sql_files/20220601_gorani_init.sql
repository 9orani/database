...
-- Started on 2022-06-01 07:14:33 UTC
...
--
-- TOC entry 3367 (class 1262 OID 40961)
...
-- Name: character_skin_color_id_seq; Type: SEQUENCE; Schema: gorani_schema; Owner: gorani_user
--

CREATE SEQUENCE gorani_schema.character_skin_color_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE gorani_schema.character_skin_color_id_seq OWNER TO gorani_user;

--
-- TOC entry 3369 (class 0 OID 0)
-- Dependencies: 215
-- Name: character_skin_color_id_seq; Type: SEQUENCE OWNED BY; Schema: gorani_schema; Owner: gorani_user
--

ALTER SEQUENCE gorani_schema.character_skin_color_id_seq OWNED BY gorani_schema.character_color.id;
...
-- Dependencies: 210
-- Name: player_id_seq; Type: SEQUENCE OWNED BY; Schema: gorani_schema; Owner: gorani_user
--

ALTER SEQUENCE gorani_schema.player_id_seq OWNED BY gorani_schema.player.id;
...
--
-- TOC entry 3197 (class 2604 OID 41016)
-- Name: character_color id; Type: DEFAULT; Schema: gorani_schema; Owner: gorani_user
--

ALTER TABLE ONLY gorani_schema.character_color ALTER COLUMN id SET DEFAULT nextval('gorani_schema.character_skin_color_id_seq'::regclass);
...
--
-- TOC entry 3187 (class 2604 OID 40967)
-- Name: player id; Type: DEFAULT; Schema: gorani_schema; Owner: gorani_user
--

ALTER TABLE ONLY gorani_schema.player ALTER COLUMN id SET DEFAULT nextval('gorani_schema.player_id_seq'::regclass);
...
-- Dependencies: 215
-- Name: character_skin_color_id_seq; Type: SEQUENCE SET; Schema: gorani_schema; Owner: gorani_user
--

SELECT pg_catalog.setval('gorani_schema.character_skin_color_id_seq', 1, false);
...
SELECT pg_catalog.setval('gorani_schema.player_id_seq', 1, false);
...
-- Name: character_color character_skin_color_pkey; Type: CONSTRAINT; Schema: gorani_schema; Owner: gorani_user
--

ALTER TABLE ONLY gorani_schema.character_color
    ADD CONSTRAINT character_skin_color_pkey PRIMARY KEY (id);
...
-- Completed on 2022-06-01 07:14:33 UTC
